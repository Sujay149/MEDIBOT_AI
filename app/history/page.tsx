        ...
        <div className="flex-1 flex flex-col w-full">
          ...
          <div className="flex-1 px-4 py-5 xs:px-5 xs:py-6 overflow-y-auto w-full">
            <div className="max-w-full xs:max-w-2xl sm:max-w-3xl md:max-w-4xl mx-auto space-y-5 xs:space-y-6">
              <div>
                <h1 className="text-xl xs:text-2xl font-bold text-white mb-2 xs:mb-3">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-4 xs:gap-5">
                <Card className="bg-slate-900 border-slate-800 shadow-md">
                  <CardContent className="p-4 xs:p-5 text-center">
                    ...
                    <div className="text-2xl xs:text-3xl font-bold text-purple-400 mb-1">
                      {chatSessions.length}
                    </div>
                    <div className="text-slate-400 font-medium text-sm xs:text-base">
                      Total Chats
                    </div>
                  </CardContent>
                </Card>
                <Card className="bg-slate-900 border-slate-800 shadow-md">
                  <CardContent className="p-4 xs:p-5 text-center">
                    ...
                    <div className="text-2xl xs:text-3xl font-bold text-blue-400 mb-1">
                      {totalMessages}
                    </div>
                    <div className="text-slate-400 font-medium text-sm xs:text-base">
                      Total Messages
                ...
                <Card className="bg-slate-900 border-slate-800 shadow-md">
                  <CardContent className="p-4 xs:p-5 text-center">
                    ...
                    <div className="text-2xl xs:text-3xl font-bold text-orange-400 mb-1">
                        ...
                        <div className="flex flex-col space-y-3 xs:space-y-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3 xs:space-x-4 min-w-0">
                              <h3 className="text-white font-semibold text-base xs:text-lg truncate max-w-[55%] xs:max-w-[65%]">
