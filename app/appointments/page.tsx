        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between p-3 sm:p-4 border-b border-border bg-card">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <span className="font-semibold text-lg">My Appointments</span>
            </div>
              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger asChild>
                  <Button
                    ...
                    className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg h-8 sm:h-10 px-3 sm:px-4 text-xs sm:text-sm transform hover:scale-105 transition-transform duration-200"
                  >
                ...
                <DialogContent className="bg-card border-border text-foreground max-w-[90vw] sm:max-w-2xl mx-auto max-h-[90vh] overflow-y-auto p-4 sm:p-6 rounded-xl shadow">
                  <DialogHeader>
          ...
          <div className="flex-1 p-3 sm:p-4 md:p-6 overflow-y-auto">
            <div className="max-w-full sm:max-w-4xl md:max-w-6xl mx-auto space-y-4 sm:space-y-6">
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold">Take your Doctor Appointments From here...</h1>
                <p className="text-muted-foreground text-xs sm:text-sm">Manage your medical appointments and schedules</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                <Card className="bg-card border-border rounded-xl shadow">
                  <CardContent className="p-4 sm:p-6 text-center">
                    <div className="text-2xl sm:text-3xl font-semibold text-purple-600 mb-1 sm:mb-2">{appointments.length}</div>
                    <div className="text-muted-foreground font-medium text-xs sm:text-sm">Total Appointments</div>
                  </CardContent>
                </Card>
                <Card className="bg-card border-border rounded-xl shadow">
                  <CardContent className="p-4 sm:p-6 text-center">
                    <div className="text-2xl sm:text-3xl font-semibold text-yellow-600 mb-1 sm:mb-2">{upcomingAppointments.length}</div>
                    <div className="text-muted-foreground font-medium text-xs sm:text-sm">Upcoming</div>
                  </CardContent>
                </Card>
                <Card className="bg-card border-border rounded-xl shadow">
                  <CardContent className="p-4 sm:p-6 text-center">
                    <div className="text-2xl sm:text-3xl font-semibold text-green-600 mb-1 sm:mb-2">{pastAppointments.length}</div>
                    <div className="text-muted-foreground font-medium text-xs sm:text-sm">Completed</div>
                  </CardContent>
                </Card>
              </div>
              ...
              {loading ? (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <p className="text-muted-foreground text-xs sm:text-sm">Loading appointments...</p>
                </div>
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  {upcomingAppointments.length > 0 && (
                    <div>
                      <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Upcoming Appointments</h2>
                      <div className="grid gap-3 sm:gap-4">
                        {upcomingAppointments.map((appointment) => {
                          const { status, color } = getAppointmentStatus(appointment);
                          return (
                            <Card key={appointment.id} className="bg-card border-border rounded-xl shadow">
                              <CardContent className="p-4 sm:p-6">
                                <div className="flex flex-col sm:flex-row items-start justify-between">
                                  <div className="flex-1">
                                    <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                                      <h3 className="font-semibold text-base sm:text-lg">{appointment.hospitalName}</h3>
                                    ...
                                    <div className="grid grid-cols-1 gap-3 sm:gap-4 text-xs sm:text-sm">
                                      <div className="space-y-1 sm:space-y-2">
                                        ...
                                        <div className="flex items-center text-foreground">
                                          <Calendar className="mr-2 h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground" />
                                      ...
                                      <div className="space-y-1 sm:space-y-2">
                                        ...
                                        {appointment.hospitalPhone && (
                                          <div className="flex items-center text-foreground">
                                            <Phone className="mr-2 h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground" />
                                            {appointment.hospitalPhone}
                                          </div>
                                        )}
                                  ...
                                  <div className="flex items-center space-x-1 sm:space-x-2 mt-3 sm:mt-0 sm:ml-4">
                                    ...
                                    <Button
                                      ...
                                      className="text-muted-foreground hover:text-red-500 hover:bg-muted h-8 w-8 sm:h-10 sm:w-10"
                  ...
                  {pastAppointments.length > 0 && (
                    <div>
                      <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Past Appointments</h2>
                      <div className="grid gap-3 sm:gap-4">
                        {pastAppointments.slice(0, 5).map((appointment) => (
                          <Card key={appointment.id} className="bg-card border-border rounded-xl shadow opacity-75">
                            <CardContent className="p-4 sm:p-6">
                              <div className="flex flex-col sm:flex-row items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                ...
                /* Empty State */
                <div className="bg-card border-border rounded-2xl p-6 sm:p-8 md:p-12 text-center shadow">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-muted rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 md:mb-8">
                  ...
                  <p className="text-muted-foreground mb-4 sm:mb-6 md:mb-8 max-w-xs sm:max-w-sm md:max-w-md mx-auto text-xs sm:text-sm md:text-base">
                    Book your first medical appointment to get started
                  </p>

                  <Button
                    onClick={handleAddAppointment}
                    className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg h-10 sm:h-12 px-4 sm:px-6 md:px-8 font-semibold text-xs sm:text-sm md:text-base transform hover:scale-105 transition-transform duration-200"
                  >
